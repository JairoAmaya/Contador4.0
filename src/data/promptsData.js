    ...
    subcategories: [
      {
        ...
        prompts: [
          ...
          },
          {
            ...
            prompt: `Crea un sistema de KPIs enfocado en medición de creación de valor por unidad de negocio [nombre de la línea de negocio] que incluya: ROI ajustado por riesgo para cada línea, EVA (Economic Value Added) por segmento, ratios de eficiencia de capital empleado, métricas de contribución marginal y punto de equilibrio, KPIs de cross-selling y up-selling, indicadores de satisfacción y retención por segmento, métricas de market share y posicionamiento competitivo. Establece metodología de benchmarking interno y externo, sistema de weightings para KPI composto de performance, y recomendaciones de asignación de recursos basada en KPIs de value creation.`,
            tiempoEstimado: "60 min"
          }
        ]
      },
        ...
        prompts: [
          {
            ...
            prompt: `Diseña una arquitectura de reportes automatizados que genere: reportes diarios de cash flow y posición financiera, reportes semanales de performance vs. budget, reportes mensuales de P&L completo y análisis de variaciones, reportes trimestrales de tendencias y análisis predictivo, reportes anuales de cierre con comparativos histórico. Para cada reporte especifica: fuentes de datos automáticas (ERP, CRM, etc.), algoritmos de consolidación, validaciones de calidad de datos, formato de presentación, lista de distribución automática en [nombre de área/departamento], triggers para reportes especiales por excepción, y proceso de escalamiento para anomalías detectadas.`,
            tiempoEstimado: "60 min"
          },
          {
            id: "4-2-2",
